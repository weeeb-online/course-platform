    ...
    <section className="bg-[#0D0D0D] bg-(image:--bg-hero-glow) py-20 px-6">
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="font-display text-4xl md:text-5xl font-extrabold text-white mb-4">
          Sua evolução
          <br />
          começa <span className="text-[#F9DC5C]">hoje.</span>
        </h2>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Button
            className="h-12 px-6 text-black bg-[#F9DC5C] hover:bg-[#d8bd44]"
            asChild
          >
            <a href="#planos">Começar gratuitamente</a>
          </Button>
          <Button
            className="h-12 px-6 text-[#F9DC5C] bg-transparent hover:bg-[#F9DC5C] hover:text-black border-[#F9DC5C]"
            asChild
          >
